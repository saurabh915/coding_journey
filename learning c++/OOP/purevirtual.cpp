...
public:
    ...
    //here it is default function but as it is pure virtual and base pointer is pointing to derived class the derived function display will be called and if there is no display function then this display function will not run .
